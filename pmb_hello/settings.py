...
DATABASES = {
    'default': {
        ...
        'HOST': env('DB_HOST', default='mariadb'),  # container name or IP
        ...
        # You can remove 'TIME_ZONE' from here; Django uses TIME_ZONE from the main settings
    }
}
...
TIME_ZONE = 'Asia/Kolkata'  # or 'UTC', or whatever you need
USE_TZ = True
