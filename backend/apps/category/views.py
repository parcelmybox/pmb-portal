...
def category_list(request):
    ...
    return render(request, "pages/category/list.html", {"categories": categories})
...
def shipping_price_form(request):
    # Render the HTML form page with the new template path
    return render(request, 'pages/category/shipping_price_form.html')
